...
BEGIN_RECV_TABLE_NOBASE( CPlayerLocalData, DT_Local )
	...
	RecvPropFloat	(RECVINFO(m_flFOVPunch)),
	RecvPropFloat	(RECVINFO(m_flFOVPunchVel)),
...
#endif
	DEFINE_PRED_FIELD( m_flFOVPunch, FIELD_FLOAT, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( m_flFOVPunchVel, FIELD_FLOAT, FTYPEDESC_INSENDTABLE ),
